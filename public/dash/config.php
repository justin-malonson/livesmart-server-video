        ...
        <div class="p-1">
            ...
            <form class="user">
                ...
                <?php if (@$_SESSION["tenant"] == 'lsv_mastertenant' || @$_SESSION["tenant_admin"] ) { ?>
                    <div class="form-group">
                        <label for="metaTitle" data-localize="metaTitle"></label>
                        <input type="text" class="form-control" id="metaTitle" aria-describedby="metaTitle">
                    </div>
                <?php } ?>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <?php if (@$_SESSION["tenant"] == 'lsv_mastertenant' && $paymentData['is_enabled']) { ?>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" value="1" id="payment_enabled">
                            <label class="custom-control-label" for="payment_enabled" data-localize="payment_enabled"></label>
                            <i class="fas fa-info-circle" data-bs-toggle="tooltip" id="payment_enabled_info"></i>
                        </div>
                    <?php } ?>
                </div>
                <hr>
    ...
    <?php if ($_SESSION["tenant"] == 'lsv_mastertenant') { ?>
        <div class="col-sm-6">
            <div class="p-1">
                ...
                <a href="javascript:void(0);" id="addConfig" class="btn btn-primary btn-user btn-block" data-localize="add">
                </a>
                <br/>
                <?php
