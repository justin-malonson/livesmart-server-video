        ...
        <div class="p-1">
            ...
            <form class="plan">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="interval" id="interval"><option value="D" data-localize="day"></option><option value="W" data-localize="week"></option><option value="M" data-localize="month"></option><option value="Y" data-localize="year"></option></select>
                </div>
                <div class="form-group">
